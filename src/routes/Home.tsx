  ...
  return (
    <div>
      ...
      <div>
        ...
        <br />
        Home decoration is a wish for many of us. However, at first glance, home
        décor ideas seem very complicated and confusing. But in reality it is
        simple if you do it right. Our fast-paced busy lives often deprive us
        the time to indulge in home decoration. And in many cases, maintaining
        this décor proves to be a big hassle. Add to this the exorbitant costs
        that come with decorating a house, and every homemaker feels demotivated
        ...
        <button onClick={() => {setDocTitle(`Hi ${titleOfPage}`); setCounter(counter+1)}}>Enter</button>
        <br />
        <br />
